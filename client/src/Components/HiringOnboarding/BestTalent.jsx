  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 px-4 md:px-10 items-center my-6 md:my-16">
      <div className="text-center md:text-left">
        <h3 className="text-primary md:text-2xl font-bold text-xl mb-2">
        ...
        <div className="flex flex-col md:flex-row justify-center md:justify-start gap-4 md:gap-8 my-4">
          <button className="btn btn-info btn-lg md:w-1/2">
            Gate My Free Demo
          </button>
          <button className="btn btn-outline btn-success btn-lg md:w-1/2 mt-4 md:mt-0">
            Try It Free
          </button>
        </div>
      </div>
      <div className="mt-6 md:mt-0">
        <img src={hiringImage} className="w-full h-auto rounded-2xl" alt="" />
      </div>
    </div>
  );
};
