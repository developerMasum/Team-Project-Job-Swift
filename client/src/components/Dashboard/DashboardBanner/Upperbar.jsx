...
const UpperBar = () => {
    ...
    const name = "Mr Monkey";
    const userName = "mm123"
                ...
                <div className="flex  lg:md:gap-10">
                    ...
                    <div className="dropdown text-white">
                        ...
                        >
                            <div className="">
                                <li>
                                    <Link><FaToolbox></FaToolbox>JOBS</Link>
                                </li>
                                <li>
                                    <Link><FaUserPlus></FaUserPlus>Candidates</Link>
                                </li>
                                <li>
                                    <Link><RiUserSearchFill></RiUserSearchFill>People Search</Link>
                                </li>

                                <li>
                                    <Link><BiSolidCalendar className="text-[18px]"></BiSolidCalendar>Agenda</Link>
                                </li>
                                <li>
                                    <Link><BsPieChart className="text-[17px]"></BsPieChart>Reports</Link>

                                </li>
                                <li>
                                    <Link><BsGraphUp className="text-[15px] ps-[2px]"></BsGraphUp>Activity</Link>
                    ...
                    <Link><img
                        className="h-8 w-20 rounded-xl border border-green-700"
                        src={logo2}
                        alt=""
                    /></Link>
                </div>
                ...
                <div className="font-bold hidden lg:md:flex ">
                    <ul className="menu menu-horizontal px-1  text-white">
                        ...
                        <li className="relative group">
                            <Link><BiSolidCalendar className="text-[18px]"></BiSolidCalendar></Link>
                        ...
                        <li className="relative group">
                            <Link><BsPieChart className="text-[17px]"></BsPieChart></Link>
                            <div className="opacity-0 rounded-md absolute top-14 right-0 bg-slate-600 text-white  pointer-events-none group-hover:opacity-100">
                ...
                <div className=" flex lg:md:pe-6 pe-4 gap-2 lg:md:navbar-end lg:md:gap-3">
                    ...
                    <div className="relative group">
                        <div className="rounded-full transition duration-300 ease-in-out transform hover:scale-105 group-hover:opacity-100 opacity-80">
                            <Link><button className=""><GrMail className="text-white text-2xl"></GrMail></button></Link>
                        </div>
                        <div className="opacity-0 rounded-md absolute top-12 right-0 bg-slate-600 text-white  pointer-events-none group-hover:opacity-100">
                            <Link to={'/inbox'}><h2 className="px-2 py-2 text-[10px] w-max ">Inbox</h2></Link>
                        </div>
                    </div>
                    {/* ----------------------------------- */}
                    ...
                    <div className="dropdown relative group">
                        <label tabIndex={0} className="rounded-full transition duration-300 ease-in-out transform hover:scale-125 group-hover:opacity-100 opacity-70">
                                ...
                                <div className="text-black">
                                    ...
                                    <li>
                                        <div className="border-b-4">
                                            <Link><img className="h-10 rounded-full" src={userImage} alt="" /></Link>
                                            <h2>
